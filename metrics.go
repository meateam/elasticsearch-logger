...
// NewMetricsGinLogger initializes the metrics middleware.
func NewMetricsGinLogger() gin.HandlerFunc {
...
func initESConfig() ([]es.ClientOptionFunc, string) {
	...
	return elasticOpts, viper.GetString(configElasticsearchMetricsIndex)
}
